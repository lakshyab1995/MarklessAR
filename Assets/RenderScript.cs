...
public class RenderScript : MonoBehaviour {
    ...
    private Vector3 targetSamuraiPosition;
    private Vector3 originalSamuraiPosition;
    ...
    public void Calc(float lat1, float lon1, float lat2, float lon2)
    {
        ...
        targetSamuraiPosition = originalSamuraiPosition - new Vector3(0, 0, distanceFloat * 12);
    ...
    void Start()
    {
        ...
        targetPosition = ufoObject.transform.position;
        originalPosition = ufoObject.transform.position;

        targetSamuraiPosition = samuraiObject.transform.position;
        originalSamuraiPosition = samuraiObject.transform.position;
    ...
    void Update()
    {
        ...
        ufoObject.transform.position = Vector3.Lerp(ufoObject.transform.position, targetPosition, speed);
        //rotate by 1 degree about the y axis every frame
        //transform.eulerAngles += new Vector3(0, 1f, 0);

        samuraiObject.transform.position = Vector3.Lerp(samuraiObject.transform.position, targetSamuraiPosition, speed);
